...
_SYSTEM = (
    ...
    "TITLE WORDING vs FUNCTION (bug report PART 4). Each criterion's \"type\" tells you which "
    "question you are actually answering:\n"
    "  - type \"title\" is a LITERAL job-title requirement — the person's actual title (current or "
    "past, per scope) must genuinely be that title (or an unambiguous synonym for the same rank/role, "
    "e.g. \"CEO\" / \"Chief Executive Officer\"). A person who merely DOES that kind of work under a "
    "different title does NOT satisfy a \"title\" criterion.\n"
    "  - type \"professional_concept\" / \"role_function\" / \"semantic_concept\" / "
    "\"industry_experience\" is about MEANING, not wording — it asks whether the person's actual "
    "documented responsibilities, experience, or professional function satisfy the concept, "
    "REGARDLESS of what their job title literally says. A different formal title with clearly "
    "equivalent responsibilities (grounded in the evidence, never assumed from the title alone) can "
    "still be \"true\". Do not require the query's exact wording to appear in the person's title — "
    "that would silently turn a broad experience/function request into a narrow title requirement "
